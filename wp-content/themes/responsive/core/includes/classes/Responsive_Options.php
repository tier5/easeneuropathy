...
Class Responsive_Options {
	...
	protected function sub_heading( $args ) {
		...
		if ( !isset( $args['width'] ) || $args['width'] != 'full' ) {
			...
			echo '<div class="grid col-300 ' . $class . '">';
	...
	protected function text( $args ) {
		...
		$html = '<input id="' . esc_attr( 'responsive_theme_options[' . $id . ']' ) . '" ' . $visibility . ' class="regular-text" type="text" name="' . esc_attr( 'responsive_theme_options[' . $id . ']' ) . '" value="'
			. esc_html( $value ) . '"
        placeholder="' .
	...
	protected function select( $args ) {
		...
		$html = '<select id="' . esc_attr( 'responsive_theme_options[' . $id . ']' ) . '" name="' . esc_attr( 'responsive_theme_options[' . $id . ']' ) . '"' . $visibility . '>';
	...
	protected function checkbox( $args ) {
		...
		$html = '<input id="' . esc_attr( 'responsive_theme_options[' . $id . ']' ) . '" ' . $visibility . ' name="' . esc_attr( 'responsive_theme_options[' . $id . ']' ) . '" type="checkbox" value="1" ' . $checked . '
         />
