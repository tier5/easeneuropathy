		...
		<div class="grid col-940">
			...
			<div class="grid col-380 fit">
				<?php
					...
					/*	Social icons based on Design selected
					*	Keep Support for Legacy Responsive social icons(images)
					*	@since 1.0.2.6
					*/

					$footer_icon_design_type = ( empty($responsive_options['social_icon_design']) ? 'default-styling' : $responsive_options['social_icon_design'] );

					if ( $footer_icon_design_type == 'default-styling' ){
						echo responsive_get_social_icons();
					}
					else{
						echo responsivepro_get_social_icons( $footer_icon_design_type );
					}
				?>
			</div>
			<!-- end of col-380 fit -->
