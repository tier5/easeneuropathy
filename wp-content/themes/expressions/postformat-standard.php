...
if ( $display_post_icon == 1 ) {
	...
	echo '<div class="post-icon">';
		...
		if($use_pformat_font_icons == 1 ){
			echo '<i class="post-icon-format fa fa-align-justify" title="standard"></i>';		
		} else {	
			echo '<img class="post-icon-format" src="'.get_template_directory_uri().'/images/format-standard_24.png" title="standard" alt="standard" />';		
		}
	...
	<?php ka_express_post_meta_top( 'standard' , $display_post_timestamp , $display_post_author , $display_post_categories ); ?>
	...
	<?php ka_express_post_meta_bottom( 'standard' , $display_post_tags ); ?>
