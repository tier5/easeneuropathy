 ...
 * Tag template file
 *
 * This file is the Tag Page template file, which is output whenever
...
<?php 
	...
	$tag_sidebar_loc = $kaex_options['kaex_tag_sidebar_loc']; 
?>
<?php get_header(); ?>
<div id="main-section">
	<div id="content-wrap">
		<?php if ( $tag_sidebar_loc == 'left') { ?>
			<div id="widecolumn-right">
		<?php } else { ?>
			<div id="widecolumn-left">
		<?php } ?>
			<div class="category-page">
				<h2><?php _e('Posts for Tag : ','ka_express'); echo single_cat_title(); ?></h2>
			</div>
