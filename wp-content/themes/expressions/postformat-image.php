...
if ( $display_post_icon == 1 ) {
	...
	echo '<div class="post-icon">';
		...
		if($use_pformat_font_icons == 1 ){
			echo '<i class="post-icon-format fa fa-camera" title="image"></i>';		
		} else {	
			echo '<img class="post-icon-format" src="'.get_template_directory_uri().'/images/format-image_24.png" title="image" alt="image" />';		
		}
	...
	<?php ka_express_post_meta_top( 'image' , $display_post_timestamp , $display_post_author , $display_post_categories ); ?>
	...
	<?php ka_express_post_meta_bottom( 'image' , $display_post_tags ); ?>
