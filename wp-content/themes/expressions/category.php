...
<?php 
	...
	$category_sidebar_loc = $kaex_options['kaex_category_sidebar_loc']; 
?>
<?php get_header(); ?>
<div id="main-section">
	<div id="content-wrap">
		<?php if ( $category_sidebar_loc == 'left') { ?>
			<div id="widecolumn-right">
		<?php } else { ?>
			<div id="widecolumn-left">
		<?php } ?>
			<div class="category-page">
				<h2><?php _e('Posts by Category : ','ka_express'); echo single_cat_title(); ?></h2>
			</div>
			...
			<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
				...
				<div class="nosearch">
					...
					<p><?php _e('You may want to try another category.','ka_express'); ?></p>
